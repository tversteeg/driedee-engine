...
#define COLOR_CYAN ((pixel_t){0, 255, 255, 255})

#define COLOR_AZURE ((pixel_t){0, 127, 255, 255})
#define COLOR_VIOLET ((pixel_t){127, 0, 255, 255})
#define COLOR_ROSE ((pixel_t){255, 0, 127, 255})
